    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0b0d12] p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-white/50">登录以访问管理后台</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className={cn(
                ...
                error && !email.trim() && 'border-red-500/50',
              )}
            />
          </div>
            ...
            <div className="relative">
              <input
                ...
                className={cn(
                  ...
                  'placeholder:text-white/30 focus:border-brand-500/50 focus:outline-none',
                  error && !password && 'border-red-500/50',
                )}
              />
              <button
                type="button"
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2">
              ...
              />
              <span className="text-sm text-white/60">记住密码</span>
            </label>
          </div>
        ...
        <div className="rounded-lg border border-white/10 bg-white/[0.03] p-4">
          <p className="mb-2 text-xs font-medium text-white/50">测试账号：</p>
          <div className="space-y-1 text-xs text-white/40">
            <p>管理员：admin@example.com / admin123</p>
            <p>普通用户：user1@example.com / user123</p>
          </div>
        </div>
      </div>
    </div>
